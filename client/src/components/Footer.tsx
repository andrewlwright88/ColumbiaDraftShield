        ...
        <div className="container max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <img src={IMG.logoWhite} alt="TrimMaster by Columbia Aluminum Products" className="h-8 opacity-80" />
              <div className="w-px h-8 bg-white/15 hidden md:block" />
              <img src={IMG.logoEndorsed} alt="Columbia Aluminum Products" className="h-6 opacity-60" />
            </div>
